      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-extrabold text-yellow-400">M A-Store</h3>
            <p className="text-gray-300 text-sm">
              Discover the best deals and exclusive products at M A-Store. Shop confidently with excellent customer support.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/Contact" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">
                Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-6 border-t border-gray-700 pt-4 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} M A-Store. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
